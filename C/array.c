...
int firstElement(int array[], int size) { return array[0]; }

// Get the last element of the array
int lastElement(int array[], int size) { return array[size - 1]; }

// Get the value at the specified index
int elementAtIndex(int array[], int size, int index) { return array[index]; }
